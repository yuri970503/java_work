...
public class CompareStr {
	...
	System.out.println("== 연산자와의 결과: "+(password==kim.pw));
	//문자열 비교 X  단순히 주소를 비교하는것이다. 객체타입은 쓸대가 없다. 쓰지말아라 문자열 내영 값 그 자체를 비교할때는 못쓴다.
	System.out.println("equals의 연산 결과: "+(password.equals(kim.pw)));
	}
